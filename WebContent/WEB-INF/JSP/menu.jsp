...
<header>
	<nav><ul>
		...
		<li><a href="<c:url value='/pizzas/tussenprijzen.htm'/>">Pizza’s tussen prijzen
		</a></li>
		...
		<li><a href="<c:url value='/cookies.htm'/>">Cookies</a></li>
		<li><a href="<c:url value='/headers.htm'/>">Headers</a></li>
		<li><a href="<c:url value='/pizzas/bestellen.htm'/>">Bestellen</a></li>
	</ul></nav>
</header>

<!-- omdat we het menutje in elke jsp laten zien kunnen we hem best in een apparte jsp zetten en 
deze in de jsp's inladen waar het nodig is -->